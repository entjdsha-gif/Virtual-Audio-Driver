# Phase 4 Step 3: Live-call render validation
...
```powershell
python scripts/execute.py mark 4-render-coupling 3 completed --message "Render live-call clean, parity with VB on render side."
```
