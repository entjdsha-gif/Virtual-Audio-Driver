# Phase 5 Step 2: Live-call end-to-end validation

## Read First

- Phase 4 Step 3 (render-only validation pattern).
...
7. Compare AO vs VB on three axes:
   ...
   - Driver counters (overflow / underrun / drop).
...
- Open a fix-up step (`Phase 5 Step 2-fix-1`) describing the failure
...
```powershell
python scripts/execute.py mark 5-capture-coupling 2 completed --message "Live call AO parity with VB."
```
